...
- Verification Result: `npm test` in `peer-bridge/server` passed (`4` files, `17` tests).
...
- Verification Result: `npm test` in `peer-bridge/server` passed.
...
- Verification Result: `npm test` in `peer-bridge/extension` passed.
...
- Verification Result: `npm test` passed in both `peer-bridge/server` and `peer-bridge/extension`.
